...
const PROFILES = [
  {
    ...
    color: "green",
    tagline: "You evaluate tools like an engineer, not a consumer. Honestly, it's suspicious.",
  ...
  },
  {
    ...
    color: "yellow",
    tagline: "Good instincts, questionable boundaries. Like someone who meal-preps but orders Uber Eats on Fridays.",
  ...
  },
  {
    ...
    color: "orange",
    tagline: "You're not choosing a tool. You're hoping one will choose you.",
  ...
  },
  {
    ...
    color: "red",
    tagline: "You don't need a framework. You need a mass, a lawyer, and possibly an exorcist.",
